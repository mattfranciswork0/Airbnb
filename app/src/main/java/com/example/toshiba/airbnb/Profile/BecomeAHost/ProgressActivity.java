...
public class ProgressActivity extends AppCompatActivity {
    public static final String PROGRESS_SP = "PROGRESS_SP";
    ...
    public void onBackPressed() {
        ...
        //PhotoFragment
        final SharedPreferences captionSP = getSharedPreferences(PhotoDescFragment.CAPTION_SP, Context.MODE_PRIVATE);
        final EditText etCaption = (EditText) currentFragment.getView().findViewById(R.id.etCaption);
        //TitleFragment
        ...
        final EditText etArriveAfter = (EditText) currentFragment.getView().findViewById(R.id.etArriveAfter);
        ...
        dialog.setPositiveButton("Save", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int id) {
                ...
                } else if (currentFragment instanceof PhotoDescFragment) {
                    SharedPreferences.Editor edit = captionSP.edit();
                    String stringImageUri = describePlaceSP.getString(((PhotoDescFragment) currentFragment).getStringImageUri(), "");
                    edit.remove(stringImageUri);
                    edit.putString(stringImageUri, etCaption.getText().toString());
                    edit.apply();
                    ProgressActivity.super.onBackPressed();
        ...
        if (currentFragment instanceof DescribePlaceFragment) {
            ...
            if(!(etCaption.getText().toString().equals(captionSP.getString(
                    ((PhotoDescFragment) currentFragment).getStringImageUri(), ""))
            )){
                dialog.create().show();
            } else{
                super.onBackPressed();
            ...
            if (!(etAdditionalRules.getText().toString().equals(houseSP.getString(HouseRuleFragment.ADDITIONAL_RULES, "")))) {
                dialog.create().show();
            } else {
                //if already saved/no saved needed to be make, go back
                super.onBackPressed();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getExtras().getBoolean(BecomeAHostActivity.SCENE_BUTTON)) {
            ...
            if (progressSP.contains(PhotoFragment.PHOTOFRAGMENT_REMOVE)) {
