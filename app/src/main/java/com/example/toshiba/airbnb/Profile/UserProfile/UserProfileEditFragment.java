        ...
        if (sessionManager.isLoggedIn()) {
            ...
            tvEditAboutMe.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    UserProfileEditDetailFragment userProfileEditDetailFragment = new UserProfileEditDetailFragment();
                    Bundle bundle = new Bundle();
                    bundle.putBoolean(ABOUT_ME_EDIT, true);
                    userProfileEditDetailFragment.setArguments(bundle);
                    getFragmentManager().beginTransaction().replace(R.id.hostProfileLayout, userProfileEditDetailFragment).addToBackStack(null).commit();
                }
            });
