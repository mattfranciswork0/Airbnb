...
import com.example.toshiba.airbnb.Profile.UserProfile.UserProfileViewFragment;
...
//                                captionArrayList.add(response.body().getImageData().get(i).getCaption() + "");
                            ...
                            public void onResponse(Call<POJOUserData> call, Response<POJOUserData> response) {
                                ...
                                ivHost.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        getFragmentManager().beginTransaction().add(R.id.homeDescLayout, userProfileViewFragment).hide(HomeDescFragment.this)
            ...
            ivHost.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    getFragmentManager().beginTransaction().replace(R.id.homeDescLayout, new UserProfileViewFragment()).
                            addToBackStack(null).commit();
                }
            });
            loadSDCard();
